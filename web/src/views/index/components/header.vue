<template>
  <a-row class="main-bar-view" align="center">
    <a-col class="logo" :xs="0" :sm="0" :md="4" :lg="4">
      <img :src="logoImage" class="search-icon" @click="$router.push({ name: 'portal' })" />
    </a-col>
    <a-col class="search-entry" :xs="4" :sm="18" :md="14" :lg="14">
      <input placeholder="输入关键词" ref="keywordRef" @keyup.enter="search" />
      <button class="button">搜索</button>
    </a-col>
    <a-col class="right-view" :xs="0" :sm="0" :md="4" :lg="4">
