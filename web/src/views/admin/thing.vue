...
const getDataList = () => {
  ...
  listApi({
    ...
    .then((res) => {
      ...
      pages.total = res.data.pages;
      console.log(pages.total, '总数返回');
    })
    .catch((err) => {
      data.loading = false;
      console.log(err);
...
const changePage = (page) => {
  pages.page = page;
  pages.pageSize = page;
  console.log(pages.pageSize, pages.pageNum, '分页数据');
  getDataList({ pageSize: pages.pageSize, pageNum: pages.pageNum });
};
